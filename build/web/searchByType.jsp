...
<html>
    ...
    <body>
            ...
            <div id="menu">
                <nav class="menu_bg">
                    <div class="navbar" onclick="toggleSidebar()">
                        ...
                        <a href="#list_product" >DANH MỤC HOA TƯƠI</a>
                    </div>
                </nav>
                <div id="timkiem" >
                    <form name="SearchServlet" action="searchFlower.jsp" method="post">
        ...
        <%
            ...
            String typeF = request.getParameter("type").trim();
            ArrayList<Flower> list = fdb.getFlowersByType(typeF);
            int size = list.size();
            try {
        ...
        <form action="" method="post">
            <table width="100%">
                ...
                <td>
                    <div style="text-align: center; width: 100%; margin: auto;padding-left: 230px">
                        <ul style="display: inline-table;
                            ...
                            <%
                                ...
                                if (list != null) {
                                    while ((y < size - 1) && (iCounter < flowersPerPage)) {
                                        f = list.get(y);
                                        code = f.getCode();
                                        type = f.getType();
                                        name = f.getName();
                ...
                <td>
                    <div style="float:right">
                        <img src="images/img1.png" style="width: 260px;height: 320px"><br>
                        <img src="images/img2.png" style="width: 260px;height: 320px"><br>
                        <img src="images/img3.jpg" style="width: 260px;height: 320px">
                    </div>
                </td>
                </tr>
            </table>
