<%-- 
    Document   : Home
    Created on : Jun 20, 2019, 8:49:40 AM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <title>Flower Shop - Hệ Thống Bán Hoa Chất Lượng Cao</title>
        <style>
            table{
                margin:20px auto;
                padding: 0;
    ...
    <body>
        ...
        <form action="" method="post">
            <table width="100%">
                ...
                <td>
                    <div style="float:right"><img src="images/img1.png" style="width: 260px;height: 320px"><br>
